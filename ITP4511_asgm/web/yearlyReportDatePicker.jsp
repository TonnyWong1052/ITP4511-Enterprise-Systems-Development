            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <h6 style="font-size: 30px;">Select Date - Yearly Report</h6>
                    </div>
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4">
                            <form class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <a href="analysisReport.html">
                                        <button type="button" class="btn btn-primary" style="max-width: 100px;">Submit</button>
                                    </a>
