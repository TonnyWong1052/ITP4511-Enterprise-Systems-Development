<%-- 
    Document   : venues
    Created on : 2023年4月25日, 下午04:31:10
    Author     : qwer1
--%>
...
<option value="6">Chai Wan</option>
   ...
   for (int i=0; i< venue.size(); i++){
       ...
       VenueBean v = venue.get(i);
        ...
        out.println("  <div class='desbtn'><a href=AddToCart?action=addcart&id="+ v.getId() +"><button class='button-5' role='button'>" + v.getId() + "</button></a></div></div></div>");
   }
   //<a href=\"handleCustomer?action=getEditCustomer&id=" + c.getCustId() + "\">edit</a>
   %>
