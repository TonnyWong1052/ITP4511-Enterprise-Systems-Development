                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4" style="font-size: 40px;">Venue Detail</h6>
                            ...
                            <form class="row g-3" action="handleVenueDetail?action=edit&id=<%= venue.getId()%>" method="POST"  >
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="type" >
                                        <option value="Banquet Hall" <% if(venue.getType().equals("Banquet Hall")) out.println("selected"); %>  >Banquet Hall</option>
                                        <option value="Conference Room"  <% if(venue.getType().equals("Conference Room")) out.println("selected"); %> >Conference Room</option>
                                        <option value="Party Room" <% if(venue.getType().equals("Party Room")) out.println("selected"); %> >Party Room</option>
                                        <option value="Art Studio" <% if(venue.getType().equals("Art Studio")) out.println("selected"); %> >Art Studio</option>
                                        <option value="Co-working Space" <% if(venue.getType().equals("Co-working Space")) out.println("selected"); %> >Co-working Space</option>
                                    </select>
                                </div>
                                ...
                                <label for="inputPassword4" class="form-label">Location</label>
                                    <select class="form-select" aria-label="Default select example" name="location" name="location"  >
                                        <option value="Tuen Mun" <% if(venue.getLocation().equals("Tuen Mun")) out.println("selected"); %> >Tuen Mun</option>
                                        <option value="Sha Tin" <% if(venue.getLocation().equals("Sha Tin")) out.println("selected"); %> >Sha Tin</option>
                                        <option value="Tsing Yi" <% if(venue.getLocation().equals("Tsing Yi")) out.println("selected"); %> >Tsing Yi</option>
                                        <option value="Lee Wai Lee" <% if(venue.getLocation().equals("Lee Wai Lee")) out.println("selected"); %> >Lee Wai Lee</option>
                                        <option value="Chai Wan" <% if(venue.getLocation().equals("Chai Wan")) out.println("selected"); %> >Chai Wan</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="active" >
                                        <option value="1" <% if(venue.getIsActive().equals("1")) out.println("selected"); %> >Avabiliable</option>
                                        <option value="0" <% if(venue.getIsActive().equals("0")) out.println("selected"); %> >Unavabiliable</option>
                                    </select>
                                </div>
